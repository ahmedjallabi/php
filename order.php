        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                <fieldset>
                    ...
                    ?>
                   <img src="<?php echo SITEURL; ?>images/foods/<?php  echo $image_name;?>" alt="" class="img-responsive img-curve">
                   <?php
                ...
                <fieldset>
                    ...
                    <textarea name="adress" rows="10" placeholder=" Country" class="input-responsive" required></textarea>
                ...
                $food = $_POST['food'];
                 $price = $_POST['price'];
                  ...
                  customer_adress = '$customer_adress'";
                   ...
                   if($res2==true){
                    $_SESSION['order']="Food ordred success";
